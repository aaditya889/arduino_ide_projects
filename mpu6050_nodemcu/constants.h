...
const uint8_t COMBINE_MPU_DATA_TICKER_INTERVAL_MS = 3, BALANCE_DRONE_TICKER_INTERVAL_MS = 4, UDP_STATS_EXPORTER_INTERVAL_MS = 5;
const float BALANCE_SENSITIVITY = 1.8;
const float BALANCE_AMPLITUDE = 0.8;
