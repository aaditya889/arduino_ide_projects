...
// const uint8_t COMBINE_MPU_DATA_TICKER_INTERVAL_MS, BALANCE_DRONE_TICKER_INTERVAL_MS, UDP_STATS_EXPORTER_INTERVAL_MS;
// float BALANCE_SENSITIVITY;
// float BALANCE_AMPLITUDE;

// const char REMOTE_IP[] = "192.168.43.13";
// const uint16_t REMOTE_PORT = 8000;
// const uint8_t MIN_PULSE;
// const uint8_t MAX_PULSE;
...
// BLA::Matrix<3> ADX = {0,1,0}, ADY = {-1,0,0}, ADZ = {0,0,0}, MPU_ACC_OFF = {0,0,1}, DES_YPR;
// BLA::Matrix<3,3> ANGLE_DELTA_TRANSFORM = {0,-1,0, 1,0,0, 0,0,0};
// // Changing global variables
// BLA::Matrix<3> MPU_ACC_AVG, MPU_GYRO_AVG, YPR_GYRO, YPR;
// BLA::Matrix<4> CURRENT_THRUST_VECTOR, DESIRED_THRUST_VECTOR, CURRENT_THRUST_RATIO;

// uint32_t MPU_START_TIME = 0, MPU_END_TIME = 0;
// uint8_t FLIGHT_THRUST;
// int FLIGHT_THRUST_DIFF;

// void reinitialise_constants(boolean force)
// {
//   if (!force && REINIT_CALLED > 0) return;
  
//   REINIT_CALLED++;

//   COMBINE_MPU_DATA_TICKER_INTERVAL_MS = 3;
//   BALANCE_DRONE_TICKER_INTERVAL_MS = 1;
//   UDP_STATS_EXPORTER_INTERVAL_MS = 5;
//   BALANCE_SENSITIVITY = 1.7;
//   BALANCE_AMPLITUDE = 0.8;
//   MIN_PULSE = 0;
//   MAX_PULSE = 180;
